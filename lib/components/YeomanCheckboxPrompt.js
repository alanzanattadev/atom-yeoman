      ...
      <div className="yeoman-checkbox-prompt">
        {this.props.choices.map((choice, i) => (
          <div className="choice" key={`choice${i}`}>
            ...
            <input type="checkbox" checked={this.state.values.find(v => v == (typeof choice == 'string' ? choice : choice.value)) !== undefined} onChange={(e) => this.onChange(typeof choice == 'string' ? choice : choice.value)}/>
          </div>
        ))}
